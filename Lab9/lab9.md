...
The blue LED blinks after every ToF reading. This was helpful for debugging and checking that data was being collected at each new angle after the car stopped oscillating. There was some drift, but the car stayed within the 1x1 ft square. The drifting from center can be attributed uneven motor power, the floor (wheel slip, friction), and PID overshooting. The final position was offset from the center by ~1.5 inches in the x direction and ~0.5 inches in the y direction. In a 4x4 foot square. In a 4x4m square, this would cause less than a 1% error. 
